<template>
  <div class="project shadow-lg bg-primary-light rounded-lg">
    <div
    ...
    >
      <div>
        <div class="my-4 clearfix">
          <i
            class="float-left text-label-info text-4xl"
            :class="parentData.icon"
          ></i>
          <a class="float-right" :href="parentData.link">
            <i
              class="fas fa-link text-lg text-label-info hover:text-primary-light"
            ></i>
          </a>
        </div>
      ...
      <div class="py-2 ">
        <div class="flex items-center py-4">
          <div class="text-sm">
            <p class="text-label-info leading-none">
              <b>Author:</b> {{ parentData.developer }}
            </p>
        ...
        <span
          class="inline-block rounded-full text-sm text-label-subtitle mr-1"
