<template>
  <div class="flex-col justify-center">
    <h1 class="font-bold text-transparent-secondary md:text-5xl text-4xl">
      About Me
    </h1>

    <div class="my-8 md:flex bg-background-light rounded-lg p-8">
      <img
        class="h-24 w-24 md:h-24 md:w-24 rounded-lg mx-auto md:mx-0 sm:my-4 md:my-0 md:mr-6"
        src="../assets/img/avatar.jpg"
      />
      <div class="text-center md:text-left">
        <!-- <span class="text-label-subtitle font-bold text-xl "> ➔➔➔ an introduction </span><br/> -->
        <p class="text-label-info text-lg">
          <span class="uppercase text-sm font-bold text-label-subtitle">{{
            profile.startDescription
          }}</span
          >{{ profile.description }}
        </p>
      </div>
    ...
    <div class="w-full my-4">
      ...
      <div class="skills">
        <div class="shadow-lg rounded-sm bg-background-light p-6">
          <span class="text-label-subtitle font-bold text-lg my-2"
            >Programming Languages & Tech</span
          >
          <Technology
      ...
      <div class="shadow-lg rounded-sm bg-background-light p-6 my-4">
        <span class="text-label-subtitle font-bold text-lg my-2">Tools</span
        ><br />
        <span
        ...
        >
          ➔ <span class="text-label-info">{{ item.name }}</span></span
        >
      </div>
    </div>

    <div class="w-full my-8">
      <span class="text-secondary-main font-bold text-lg my-2"
        >➔ Experience
      </span>
      <Timeline />
    </div>
